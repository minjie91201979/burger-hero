...
export class SurvivalShooterPreloadScene extends Scene {
  constructor() {
    super({ key: 'SurvivalShooterPreloadScene' });
  }
  ...
  create(): void {
    this.scene.start('SurvivalShooterSelectScene');
  }
}
